<div align="center" style="margin-bottom: 30px;">
    ...
    <div>
        <i>Automatic Semantic Versioniser & Change Tracker <code>[0.5.2]</code></i>
    </div>
</div>
...
- You can start start any line in message with `A:` _(added)_, `F:` _(fixed)_, `R:` _(removed)_, ... etc., to [tag](./src/gitversioniser/config/commit_changelog_tags/core/classic_changelog.py) the action you did, which will create corresponding changelog entry.
...
Using this repository out-of-the-box gives you a free, automatically managed `CHANGELOG.md` file. It uses [prefix tags](./src/gitversioniser/config/commit_changelog_tags/core/classic_changelog.py) that are one-letter shorthands of the joint summarization of a commit. This will encourage the developers to create tiny and descriptive commits. Additionally, there will be no more fights over the usage of imperative _"Fix"_ or declarative _"Fixed"_. Everyone can add the rest individually in their thoughts to their liking.
