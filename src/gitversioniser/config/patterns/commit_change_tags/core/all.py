...
class All(CommitChangeTags):
    ...
    database: CommitTag = ChangelogCategory.DATABASE.value
    ...
    fixed_bug: CommitTag = ChangelogCategory.FIXED_BUG.value
    ...
    mobile: CommitTag = ChangelogCategory.MOBILE.value
    ...
    version: CommitTag = ChangelogCategory.VERSION.value
