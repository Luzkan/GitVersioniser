...
from gitversioniser.domain.versioniser.routines.changelog.core import CommitChangelogTags, LastCommitMessageAsDescription, Null
...
class RoutineChangelogFactory(RoutineFactory):
    ...
    def create(routine_version_name: ROUTINE_CHANGELOG_TYPE) -> type[RoutineChangelog]:
        return {
            ...
            RoutineFactory.skip_init(CommitChangelogTags).factory_name(): CommitChangelogTags,
