...
from gitversioniser.domain.versioniser.routines.commit_message import RoutineCommitMessageFactory
...
class Versioniser:
    def __init__(self, config: Config) -> None:
        ...
        self.routine_manager = RoutineManager(
            ...
            commit_message=RoutineCommitMessageFactory.create(config.routines.commit_message)(*deps),
