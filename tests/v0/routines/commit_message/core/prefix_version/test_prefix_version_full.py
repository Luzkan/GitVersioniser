...
class TestPrefixVersionFull(TestRoutineCommitMessage):
    def setUp(self):
        super().setUp()
        self.routine = self.get_routine('PrefixVersionFull')

    @parameterized.expand([
        (SemverTag.init_spec(1, 0, 0), 'Initial Commit', '[`1.0.0`] Initial Commit'),
        (SemverTag.init_spec(2, 4, 6, 'rc.3', 'build.4'), 'F: Calculate Zombie Damage', '[`2.4.6-rc.3+build.4`] F: Calculate Zombie Damage'),
        (SemverTag.init_spec(0, 0, 0, build='build.1'), 'A: Heyy!', '[`0.0.0+build.1`] A: Heyy!'),
        (SemverTag.init_spec(0, 0, 0, prerelease='rc.1'), ':3', '[`0.0.0-rc.1`] :3'),
        (SemverTag.init_spec(0, 0, 0, prerelease='rc.3', build='build.7'), ':3', '[`0.0.0-rc.3+build.7`] :3'),
    ])
