...
class TestPrefixVersionMajorMinorPatch(TestRoutineCommitMessage):
    ...
    @parameterized.expand([
        ...
        (SemverTag.init_spec(2, 4, 6, 'rc.3', 'build.4'), 'F: Calculate Zombie Damage', '[`2.4.6`] F: Calculate Zombie Damage'),
        (SemverTag.init_spec(0, 0, 0, build='build.1'), 'A: Heyy!', '[`0.0.0`] A: Heyy!'),
        (SemverTag.init_spec(0, 0, 0, prerelease='rc.1'), ':3', '[`0.0.0`] :3'),
        (SemverTag.init_spec(0, 0, 0, prerelease='rc.3', build='build.7'), ':3', '[`0.0.0`] :3'),
    ])
