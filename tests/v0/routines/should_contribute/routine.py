...
from gitversioniser.domain.versioniser.routines.should_contribute.factory import RoutineShouldContributeFactory
...
class TestRoutineShouldContribute(TestDefaultScenarioV0):
    def get_routine(self, routine_name: ROUTINE_SHOULD_CONTRIBUTE):
        return RoutineShouldContributeFactory.create(routine_name)(
